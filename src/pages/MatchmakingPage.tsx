...
import MatchmakingForm from '@/components/VedicAstrology/MatchmakingForm';
import MatchmakingChart from '@/components/VedicAstrology/MatchmakingChart';
import { calculateVedicChart } from '@/services/vedicAstroService';
import { calculateAshtakoota, extractMoonPosition } from '@/utils/AshtakootEngine';
...
const MatchmakingPage = () => {
  ...
  const [maleName, setMaleName] = useState('Bên Nam');
  const [femaleName, setFemaleName] = useState('Bên Nữ');
  ...
  const handleSubmit = async (data: any) => {
    ...
    // Save names
    setMaleName(data.male.name || 'Bên Nam');
    setFemaleName(data.female.name || 'Bên Nữ');
  ...
  return (
    <div className="min-h-screen bg-votive-bg">
      <NavBar />
        ...
        <Card className="max-w-3xl mx-auto mt-8 bg-muted/30">
          <CardContent className="pt-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-xs">
              ...
              <div className="p-2 bg-background rounded">
                <span className="font-medium">Tara (3)</span>
                <p className="text-muted-foreground">Sao may mắn</p>
              </div>
              <div className="p-2 bg-background rounded">
              ...
              <div className="p-2 bg-background rounded">
                <span className="font-medium">Bhakoot (7)</span>
